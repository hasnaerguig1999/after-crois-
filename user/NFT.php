...
session_start();
    $max__price = mysqli_query($connection, "SELECT * FROM nft order by price;");
    $min__price = mysqli_query($connection, "SELECT * FROM nft order by price desc ;");
    $max__nft__row = mysqli_fetch_assoc($max__price);
    $min__nft__row = mysqli_fetch_assoc($min__price);
    ...
    <section class="hero__section">
        ...
        <div class="nft_top_down">
            <div class="nft_top">
                <p>cheapest</p>
                <div class="nft__card">
                <div class="collection__img" style="background-image: url('../<?php echo $max__nft__row['NFT__IMG'] ; ?>');">
                    <div class="nft__info">
